		...
		return (
				<section className="semi-transparent-box">
					...
					<div  className="strongest">Every day millions of great <span id="ideas-color0">ideas</span>, <span id="ideas-color1">dreams</span>, and <span id="ideas-color2">aspirations</span> go unfilled...</div>
					    ...
					    We at Purposeful believe that when people have access to the right skills, resources, and network, their ideas can be heard.
						Our voice as a collective community is stronger when we are fueled by our passions and guided by those with experience and similar passions.
					    We decided to build a platform for people to find and pursue their purpose in life. A social platform for connecting us to our purpose.
						</div>
						<br/>
