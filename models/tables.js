...
/* the foreignKey values may seem switched but this is intentional.
* otherwise the caccessors auto-generated by Sequelize (user.getMentors() and user.getMentees()) 
* accessors do the opposite of what we expect. 
*/
